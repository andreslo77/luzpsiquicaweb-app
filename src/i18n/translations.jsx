...
export const translations = {
  ...
  en: {
    ...
    legal: {
      ...
      s8Body: "The minutes purchased within the Luz Psíquica platform constitute digital credits for exclusive use within the service ecosystem and do not represent cash, deposits, withdrawable balances, financial instruments, or transferable assets.\n\nAccordingly, all purchases of minutes made within the application are final, definitive, and non-refundable, including cases where the user chooses not to use all or part of the purchased minutes.\n\nNon-use of the service by the user, whether total or partial, does not generate any right to a refund, compensation, indemnification, or any form of economic reimbursement.\n\nMinutes cannot be converted into money, transferred to third parties, withdrawn from the platform, or claimed as a balance outside the Luz Psíquica environment.\n\nThe user expressly acknowledges that, by making a purchase within the platform, they are acquiring a digital service intended for immediate or on-demand consumption and waive, to the extent permitted by applicable law, any right of withdrawal, cancellation, or refund.\n\nExceptionally, the platform may evaluate requests only in cases of verifiable technical failures directly attributable to Luz Psíquica that have effectively prevented the provision of the service. In such cases, any measure will be strictly limited to correcting the error or proportionally restoring the service within the platform, without implying any monetary refund.\n\nThe platform reserves the right to reject any request when there are indications of fraud, abuse, misuse of the system, attempts to bypass controls, technical manipulation, or non-compliance with the established rules.\n\nDecisions adopted by Luz Psíquica in relation to these provisions shall be final within the operational scope of the platform and shall not give rise to additional compensation, interest, indemnification, or claims beyond any technical adjustments that may be determined, if applicable.\n\n",
      ...
      s10Body: "The user may request voluntary withdrawal from the platform, which must be communicated at least five (5) calendar days in advance.\n\nVoluntary withdrawal does not entitle the user to any refund of amounts paid for unused minutes, nor to any compensation, indemnification, or monetary reimbursement of any kind.\n\nAny remaining minutes at the time of withdrawal cannot be converted into money, transferred, or claimed as a balance outside the platform.\n\nThe withdrawal request and its processing shall be carried out in accordance with Luz Psíquica’s internal procedures, without implying any obligation of economic recognition by the platform.\n\nThe deletion of the account or termination of the user’s participation does not alter the non-refundable nature of previously acquired services.\n",
  ...
  fr: {
    ...
    legal: {
      ...
      s8Body: "Les minutes achetées au sein de la plateforme Luz Psíquica constituent des crédits numériques destinés à un usage exclusif dans l’écosystème du service et ne représentent pas de l’argent liquide, des dépôts, des soldes retirables, des instruments financiers ni des actifs transférables.\n\nPar conséquent, tous les achats de minutes effectués dans l’application sont finaux, définitifs et non remboursables, y compris lorsque l’utilisateur choisit de ne pas utiliser tout ou partie des minutes acquises.\n\nLa non-utilisation du service par l’utilisateur, totale ou partielle, ne donne droit à aucun remboursement, compensation, indemnisation ni reconnaissance économique.\n\nLes minutes ne peuvent être converties en argent, transférées à des tiers, retirées de la plateforme ni réclamées comme un solde en dehors de l’environnement Luz Psíquica.\n\nL’utilisateur reconnaît expressément qu’en effectuant un achat sur la plateforme, il acquiert un service numérique à consommation immédiate ou à la demande et renonce, dans la mesure permise par la loi applicable, à tout droit de rétractation, d’annulation ou de remboursement.\n\nExceptionnellement, la plateforme pourra examiner les demandes uniquement en cas de défaillances techniques vérifiables directement imputables à Luz Psíquica ayant empêché la prestation du service. Dans ce cas, toute mesure sera strictement limitée à la correction de l’erreur ou à la restitution proportionnelle du service au sein de la plateforme, sans remboursement monétaire.\n\nLa plateforme se réserve le droit de rejeter toute demande en cas d’indices de fraude, d’abus, d’utilisation abusive du système, de tentative de contournement des contrôles, de manipulation technique ou de non-respect des règles établies.\n\nLes décisions prises par Luz Psíquica à cet égard seront définitives dans le cadre opérationnel de la plateforme et ne donneront lieu à aucune compensation, intérêt, indemnisation ni réclamation au-delà des ajustements techniques éventuellement effectués.\n\n",
      ...
      s10Body: "L’utilisateur peut demander son retrait volontaire de la plateforme, qui doit être communiqué au moins cinq (5) jours calendaires à l’avance.\n\nLe retrait volontaire ne donne droit à aucun remboursement des montants payés pour les minutes non utilisées, ni à aucune compensation, indemnisation ou restitution financière.\n\nLes minutes restantes au moment du retrait ne peuvent être converties en argent, transférées ou réclamées comme solde en dehors de la plateforme.\n\nLa demande de retrait et son traitement seront effectués conformément aux procédures internes de Luz Psíquica, sans que cela implique une quelconque obligation de compensation économique de la part de la plateforme.\n\nLa suppression du compte ou la cessation de la relation avec l’utilisateur ne modifie pas le caractère non remboursable des services acquis antérieurement.\n",
  ...
  de: {
    ...
    legal: {
      ...
      s8Body: "Die innerhalb der Luz Psíquica-Plattform erworbenen Minuten stellen digitale Guthaben dar, die ausschließlich innerhalb des Service-Ökosystems genutzt werden können und kein Bargeld, keine Einlagen, keine auszahlbaren Guthaben, keine Finanzinstrumente und keine übertragbaren Werte darstellen.\n\nDementsprechend sind alle innerhalb der Anwendung getätigten Käufe von Minuten endgültig, verbindlich und nicht erstattungsfähig, einschließlich der Fälle, in denen der Nutzer die erworbenen Minuten ganz oder teilweise nicht nutzt.\n\nDie Nichtnutzung des Dienstes durch den Nutzer, sei es vollständig oder teilweise, begründet keinen Anspruch auf Rückerstattung, Entschädigung oder sonstige finanzielle Ausgleichszahlungen.\n\nMinuten können nicht in Geld umgewandelt, an Dritte übertragen, von der Plattform abgehoben oder außerhalb der Luz Psíquica-Umgebung als Guthaben geltend gemacht werden.\n\nDer Nutzer erkennt ausdrücklich an, dass er mit dem Kauf innerhalb der Plattform einen digitalen Dienst zur sofortigen oder bedarfsabhängigen Nutzung erwirbt und verzichtet, soweit gesetzlich zulässig, auf jegliches Widerrufs-, Rücktritts- oder Erstattungsrecht.\n\nIn Ausnahmefällen kann die Plattform Anfragen nur dann prüfen, wenn nachweisbare technische Fehler vorliegen, die direkt Luz Psíquica zuzurechnen sind und die Leistungserbringung verhindert haben. In solchen Fällen beschränken sich die Maßnahmen ausschließlich auf die Fehlerbehebung oder die anteilige Wiederherstellung des Dienstes innerhalb der Plattform, ohne monetäre Rückerstattung.\n\nDie Plattform behält sich das Recht vor, Anfragen abzulehnen, wenn Anzeichen von Betrug, Missbrauch, unsachgemäßer Nutzung, Umgehung von Kontrollen oder Verstößen gegen die Regeln vorliegen.\n\nDie Entscheidungen von Luz Psíquica sind in diesem Zusammenhang endgültig und begründen keinen Anspruch auf zusätzliche Entschädigungen, Zinsen oder Forderungen über etwaige technische Anpassungen hinaus.\n\n",
      ...
      s10Body: "Der Nutzer kann seinen freiwilligen Rückzug von der Plattform beantragen, der mindestens fünf (5) Kalendertage im Voraus mitgeteilt werden muss.\n\nDer freiwillige Rückzug begründet keinen Anspruch auf Rückerstattung für nicht genutzte Minuten sowie keine Entschädigung oder sonstige finanzielle Ausgleichszahlungen.\n\nVerbleibende Minuten zum Zeitpunkt des Rückzugs können nicht in Geld umgewandelt, übertragen oder außerhalb der Plattform als Guthaben geltend gemacht werden.\n\nDer Rückzugsantrag und dessen Bearbeitung erfolgen gemäß den internen Verfahren von Luz Psíquica, ohne dass hieraus eine Verpflichtung zur finanziellen Entschädigung entsteht.\n\nDie Löschung des Kontos oder die Beendigung der Nutzung ändert nichts an der Nicht-Erstattungsfähigkeit der zuvor erworbenen Dienstleistungen.\n",
  ...
  pt: {
    ...
    legal: {
      ...
      s8Body: "Os minutos adquiridos na plataforma Luz Psíquica constituem créditos digitais de uso exclusivo dentro do ecossistema do serviço e não representam dinheiro em espécie, depósitos, saldos sacáveis, instrumentos financeiros ou valores transferíveis.\n\nConsequentemente, todas as compras de minutos realizadas no aplicativo são finais, definitivas e não reembolsáveis, inclusive nos casos em que o usuário decida não utilizar total ou parcialmente os minutos adquiridos.\n\nA não utilização do serviço, total ou parcial, não gera direito a reembolso, compensação, indenização ou qualquer tipo de restituição econômica.\n\nOs minutos não podem ser convertidos em dinheiro, transferidos a terceiros, retirados da plataforma ou reclamados como saldo fora do ambiente Luz Psíquica.\n\nO usuário reconhece expressamente que, ao realizar uma compra na plataforma, está adquirindo um serviço digital de consumo imediato ou sob demanda e renuncia, na medida permitida pela legislação aplicável, a qualquer direito de arrependimento, cancelamento ou reembolso.\n\nExcepcionalmente, a plataforma poderá avaliar solicitações apenas em casos de falhas técnicas comprováveis atribuíveis diretamente à Luz Psíquica que tenham impedido a prestação do serviço. Nesses casos, qualquer medida será limitada à correção do erro ou à reposição proporcional do serviço dentro da plataforma, sem devolução monetária.\n\nA plataforma reserva-se o direito de rejeitar solicitações quando houver indícios de fraude, abuso, uso indevido, tentativa de burlar controles, manipulação técnica ou descumprimento das normas.\n\nAs decisões adotadas pela Luz Psíquica serão definitivas no âmbito operacional da plataforma e não gerarão direito a compensações adicionais, juros, indenizações ou reclamações além dos ajustes técnicos eventualmente realizados.\n\n",
      ...
      s10Body: "O usuário poderá solicitar sua retirada voluntária da plataforma, devendo comunicá-la com antecedência mínima de cinco (5) dias corridos.\n\nA retirada voluntária não gera direito a reembolso dos valores pagos por minutos não utilizados, nem a qualquer tipo de compensação, indenização ou devolução de dinheiro.\n\nOs minutos disponíveis no momento da retirada não poderão ser convertidos em dinheiro, transferidos ou reclamados como saldo fora da plataforma.\n\nA solicitação de retirada e seu processamento serão realizados de acordo com os procedimentos internos da Luz Psíquica, sem que isso implique qualquer obrigação de reconhecimento econômico por parte da plataforma.\n\nA exclusão da conta ou o desligamento do usuário não altera o caráter não reembolsável dos serviços previamente adquiridos.\n",
  ...
  it: {
    ...
    legal: {
      ...
      s8Body: "I minuti acquistati all’interno della piattaforma Luz Psíquica costituiscono crediti digitali utilizzabili esclusivamente all’interno dell’ecosistema del servizio e non rappresentano denaro contante, depositi, saldi prelevabili, strumenti finanziari o valori trasferibili.\n\nDi conseguenza, tutti gli acquisti di minuti effettuati nell’applicazione sono finali, definitivi e non rimborsabili, inclusi i casi in cui l’utente decida di non utilizzare totalmente o parzialmente i minuti acquistati.\n\nIl mancato utilizzo del servizio da parte dell’utente, totale o parziale, non dà diritto ad alcun rimborso, compensazione o indennizzo.\n\nI minuti non possono essere convertiti in denaro, trasferiti a terzi, prelevati dalla piattaforma né rivendicati come saldo al di fuori dell’ambiente Luz Psíquica.\n\nL’utente riconosce espressamente che, effettuando un acquisto sulla piattaforma, acquisisce un servizio digitale a consumo immediato o su richiesta e rinuncia, nella misura consentita dalla legge applicabile, a qualsiasi diritto di recesso, annullamento o rimborso.\n\nEccezionalmente, la piattaforma potrà valutare richieste solo in caso di malfunzionamenti tecnici verificabili direttamente attribuibili a Luz Psíquica che abbiano impedito la prestazione del servizio. In tali casi, qualsiasi misura sarà limitata alla correzione dell’errore o al ripristino proporzionale del servizio all’interno della piattaforma, senza rimborso monetario.\n\nLa piattaforma si riserva il diritto di respingere qualsiasi richiesta in presenza di indizi di frode, abuso, uso improprio, tentativi di eludere i controlli, manipolazioni tecniche o violazioni delle norme.\n\nLe decisioni adottate da Luz Psíquica saranno definitive nell’ambito operativo della piattaforma e non daranno diritto a compensazioni, interessi o richieste ulteriori rispetto agli eventuali adeguamenti tecnici.\n\n",
      ...
      s10Body: "L’utente può richiedere il recesso volontario dalla piattaforma, che deve essere comunicato con almeno cinque (5) giorni di anticipo.\n\nIl recesso volontario non dà diritto ad alcun rimborso degli importi pagati per minuti non utilizzati, né a compensazioni, indennizzi o restituzioni di denaro.\n\nI minuti disponibili al momento del recesso non possono essere convertiti in denaro, trasferiti o rivendicati come saldo al di fuori della piattaforma.\n\nLa richiesta di recesso e la sua elaborazione saranno effettuate secondo le procedure interne di Luz Psíquica, senza che ciò comporti alcun obbligo di compensazione economica da parte della piattaforma.\n\nLa cancellazione dell’account o l’interruzione del rapporto con l’utente non modifica la natura non rimborsabile dei servizi precedentemente acquisiti.\n",
